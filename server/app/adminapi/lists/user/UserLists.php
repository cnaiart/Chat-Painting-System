...
class UserLists extends BaseAdminDataLists implements ListsExcelInterface
{
    ...
    {
        $field = "id,sn,avatar,nickname,account,mobile,is_blacklist,channel,balance,member_end_time,member_perpetual,total_amount,create_time,balance_draw,email,is_distribution";
