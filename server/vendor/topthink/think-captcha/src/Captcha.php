...
class Captcha
{
    ...
    protected function generate(): array
    {
        ...
        Cache::set('captcha'.$hash, $bag, 300);
...
//        ]);
     ...
     */
    public function check(string $code,$key = ''): bool
    {
//        if (!$this->session->has('captcha')) {
//            return false;
//        }
//
//        $key = !empty($key) ? $key : $this->session->get('captcha.key');
//
...
//            $this->session->delete('captcha');
    ...
    public function create(string $config = null, bool $api = false)
    {
        ...
        if ($api) {
            ...
            return ['image'=>$base64_data,'key'=>$generator['key']];
        } else {
