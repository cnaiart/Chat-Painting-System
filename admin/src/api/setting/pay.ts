...
export function getEpayConfig() {
    return request.get({ url: '/setting.pay.pay_config/getEpayConfig' })
}

// 设置iOS支付
export function setEpayConfig(data: any) {
    return request.post({ url: '/setting.pay.pay_config/setEpayConfig', data })
}