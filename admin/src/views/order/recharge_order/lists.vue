<template>
    ...
    <el-card class="!border-none mt-4" shadow="never">
        <el-table size="large" v-loading="pager.loading" :data="pager.lists">
            ...
            <el-table-column label="充值套餐" min-width="120" prop="recharge_package_name">
            </el-table-column>
            <el-table-column label="套餐内容" min-width="180">
                <template #default="{ row }">
                    <div>对话次数： {{ row.number }}</div>
                    <div>绘画次数： {{ row.draw_number }}</div>
                </template>
            </el-table-column>
                ...
                <template #default="{ row }">
                    <div class="flex items-center">
                        ...
                        <el-button
                            ...
                            v-perms="['recharge.recharge_order/refund']"
                            type="warning"
                            link
