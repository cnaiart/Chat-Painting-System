<template>
    <el-card shadow="never" class="!border-none">
        <div class="flex">
            <div class="flex flex-col justify-center items-center flex-1">
                ...
                <div class="text-center">今日邀请/次</div>
            </div>
            <div class="flex flex-col justify-center items-center flex-1">
                <div class="font-medium text-[24px]">{{ pager.extend.today_chat_rewards }}</div>
                <div class="text-center">今日发放对话奖励/条</div>
            </div>
            <div class="flex flex-col justify-center items-center flex-1">
                <div class="font-medium text-[24px]">{{ pager.extend.today_draw_rewards }}</div>
                <div class="text-center">今日发放绘画奖励/条</div>
            </div>
            <div class="flex flex-col justify-center items-center flex-1">
            ...
            <div class="flex flex-col justify-center items-center flex-1">
                <div class="font-medium text-[24px]">{{ pager.extend.total_rewards }}</div>
    ...
    <el-card class="!border-none mt-4" shadow="never">
        <el-table size="large" v-loading="pager.loading" :data="pager.lists">
            ...
            <el-table-column label="对话奖励" prop="rewards" min-width="100">
                <template #default="{ row }">
                    <div>{{ row.rewards || '0' }}条</div>
                </template>
            </el-table-column>
            <el-table-column label="绘画奖励" prop="draw_rewards" min-width="100">
                <template #default="{ row }">
                    <div>{{ row.draw_rewards || '0' }}条</div>
                </template>
            </el-table-column>
        </el-table>
