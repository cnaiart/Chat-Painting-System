    ...
    <div>
        <el-card class="!border-none" shadow="never">
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item label="联网搜索" v-if="queryParams.type == '1'">
                    <el-select class="w-[280px]" v-model="queryParams.network">
                        <el-option label="全部" value="" />
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            >
                ...
                />
                <el-table-column label="用户提问" prop="ask" min-width="180">
                    <template #default="{ row }">
                        <AskPop ref="askPopRef" :content="row.ask"></AskPop>
                    </template>
                </el-table-column>
                <el-table-column v-if="queryParams.type == '1'" label="联网功能" min-width="160">
                    <template #default="{ row }">
                        <div class="flex items-center">
                            {{ row.network ? '使用' : '未使用' }}
                            <ElButton
                                ...
                                link
                                type="primary"
                                @click="showText(row.network_plugin.data)"
                            >
                                查看
                            </ElButton>
                        </div>
