...
<template>
    <div class="login-register">
        <el-form ref="formRef" :rules="rules" :model="formData" label-width="130px">
            <el-card shadow="never" class="!border-none">
                ...
                <el-form-item label="登录方式" prop="loginWay">
                    <div>
                        <el-checkbox-group v-model="formData.login_way">
                            <el-checkbox label="1">微信登录/注册</el-checkbox>
                            <el-checkbox label="2">手机号登录/注册</el-checkbox>
                            <el-checkbox label="3">邮箱登录/注册</el-checkbox>
                        </el-checkbox-group>
                        <div class="form-tips">
                ...
                <el-form-item label="注册需验证码" prop="sms_verify">
                    <div>
                        <el-switch
                            ...
                            :inactive-value="0"
                        />
                        <span class="mt-1 ml-2">{{ formData.sms_verify ? '开启' : '关闭' }}</span>

                        <div class="form-tips">
                            1、用户通过手机号码/邮箱注册帐号时，是否需要短信验证码验证填写的手机号码/邮箱，默认关闭<br />
                            2、请开启对应短信验证码功能
                        </div>
                    </div>
                </el-form-item>
                <el-form-item label="登录图形验证码" prop="is_captcha">
                    <div>
                        <el-switch
                            v-model="formData.is_captcha"
                            :active-value="1"
                            :inactive-value="0"
                        />
                        <span class="mt-1 ml-2">{{ formData.is_captcha ? '开启' : '关闭' }}</span>
                        <div class="form-tips">
                            开启后，用户每次登录都要通过图形验证码才能完成登录
                        </div>
                    </div>
                </el-form-item>
                ...
                <el-form-item label="强制绑定手机号" prop="coerce_mobile">
                    <div>
                        ...
                        <div class="form-tips">使用微信/邮箱注册方式注册登录时，要先绑定手机号</div>
                    </div>
                </el-form-item>
...
const formData = reactive<any>({
    ...
    involved_text: '',
    default_login_way: '' //默认登录方式 1-微信登录 2-手机号 3-邮箱
})
