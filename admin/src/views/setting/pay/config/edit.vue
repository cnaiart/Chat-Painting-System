    ...
    <div class="edit-popup">
        ...
        >
            <el-form ref="formRef" :model="formData" label-width="90px" :rules="formRules">
                ...
                <template v-else-if="formData.pay_way == PayWayEnum.ALIPAY">
                ...
                <template v-else-if="formData.pay_way == PayWayEnum.E_ALIPAY || formData.pay_way == PayWayEnum.E_WECHAT">
                    <el-form-item label="参数配置">
                        <div class="flex-1">
                            <router-link to="/setting/pay/e_pay">
...
const popupTitle = computed(() => {
    switch (formData.pay_way) {
        ...
        case PayWayEnum.ALIPAY:
            return '支付宝支付'
        case PayWayEnum.E_WECHAT:
            return '微信易支付'
        case PayWayEnum.E_ALIPAY:
            return '支付宝易支付'
    }
})
